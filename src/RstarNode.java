...
public class RstarNode implements Serializable {
    ...
    /**
     * A custom comparator of 2 RstarNodes based on their Rectangles we use it on ChooseSplitAxis method
    ...
    /**
     * Getter for the distance between RstarNode's Rectangle and a Point
    ...
    /**
     * Setter for the distance between RstarNode's Rectangle and a Point
     * Used only for KNN algorithm
